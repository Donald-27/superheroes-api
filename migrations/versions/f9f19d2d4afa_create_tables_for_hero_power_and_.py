"""Create tables for Hero, Power, and HeroPower

Revision ID: f9f19d2d4afa
Revises: 
Create Date: 2025-06-19 23:47:33.306835
...
def upgrade():
    ...
    sa.CheckConstraint('length(description) >= 20'),
    sa.PrimaryKeyConstraint('id')
    )
